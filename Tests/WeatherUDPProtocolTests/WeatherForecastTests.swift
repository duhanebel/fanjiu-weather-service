...
class WeatherForecastTests: XCTestCase {
    ...
    let mockData: [UInt8] = [
        0x08, 0xFF, 0xFF, 0x28, 0x05, 0xc4, 0x04
    ]
    override func setUp() {
        mockPacket = WeatherForecastBin(icon: .mostlyCloudy, tempMax: 42, tempMin: 32)
    }
    ...
    func testRoundTrip() {
        let weather = WeatherForecastBin(icon: .mostlyCloudy, tempMax: 42, tempMin: 32)
