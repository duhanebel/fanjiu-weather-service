...
struct CurrentWeatherPacket: BinaryCodable {
    ...
    init(feelsLike: Float, pressure: Float, windSpeed: Float, windDirection: UInt8) {
...
extension CurrentWeatherPacket: Equatable {
    static func == (lhs: CurrentWeatherPacket, rhs: CurrentWeatherPacket) -> Bool {
